...
//
     ...
     *
     * @param qsheetHistoryCreateDto 북마크 생성에 필요한 북마크 등록 정보를 담은 개체입니다.
    ...
    public QsheetHistoryEntity findById(String id) {
        return qsheetHistoryRepository.findById(id).orElseThrow(() -> new EntityNotFoundException("Bookmark with Id " + id + " Not Found."));
    }
